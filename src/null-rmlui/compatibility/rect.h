...
struct ntl::compatibility::data_type_converter_t<rect_t<coordinates_t>, Rml::Rectangle<coordinates_t>> {
...
template <typename coordinates_t>
struct ntl::compatibility::data_type_converter_t<Rml::Rectangle<coordinates_t>, rect_t<coordinates_t>> {
