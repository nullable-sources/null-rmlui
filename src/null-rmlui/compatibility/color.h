...
struct null::compatibility::data_type_converter_t<Rml::Colourf, null::sdk::i_color<float>> {
    static null::sdk::i_color<float> convert(const Rml::Colourf& color) { return { color.red, color.green, color.blue, color.alpha }; }
};
...
struct null::compatibility::data_type_converter_t<Rml::Colourb, null::sdk::i_color<int>> {
    static null::sdk::i_color<int> convert(const Rml::Colourb& color) { return { color.red, color.green, color.blue, color.alpha }; }
};