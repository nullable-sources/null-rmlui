...
template <>
struct null::compatibility::data_type_converter_t<null::sdk::i_color<int>, Rml::ColourbPremultiplied> {
    static inline Rml::ColourbPremultiplied convert(const null::sdk::i_color<int>& color) { return { (byte)color.r, (byte)color.g, (byte)color.b, (byte)color.a }; }
};

template <>
struct null::compatibility::data_type_converter_t<Rml::ColourbPremultiplied, null::sdk::i_color<int>> {
    static inline null::sdk::i_color<int> convert(const Rml::ColourbPremultiplied& color) { return { color.red, color.green, color.blue, color.alpha }; }
};