...
namespace null::rml::renderer::directx9::impl::shaders {
	class c_passthrough_color : public renderer::impl::shaders::i_passthrough_color, public render::backend::directx9::shaders::i_shader {
	public:
		Rml::Vector2f translation{ };

	public:
		c_passthrough_color() : i_shader{ &render::backend::directx9::shaders::compiled_objects::passthrough_color, &compiled_objects::passthrough } { }
