...
namespace null::rml::renderer::directx9::impl {
    ...
    void c_mesh::set() {
        render::backend::directx9::shared.device->SetStreamSource(0, vertex_buffer, 0, sizeof(Rml::Vertex));
        render::backend::directx9::shared.device->SetIndices(index_buffer);
        render::backend::directx9::shared.device->SetVertexDeclaration(vertex_declaration);
    }
}