...
int main() {
    window = ntl::render::directx9::c_window{ };
    ...
    window.callbacks.at<ntl::win::e_window_callbacks::on_wnd_proc>().add([](HWND, UINT msg, WPARAM, LPARAM) { if(msg == WM_SIZE) { Rml::ReleaseTextures(); Rml::ReleaseCompiledGeometry(); } return -1; });
    ...
    try {
        ...
        ntl::rml::render_interface = std::make_unique<ntl::rml::directx9::c_render>();
